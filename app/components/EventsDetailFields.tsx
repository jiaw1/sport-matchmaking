...
export default function EventDetailsFields({
  ...
  return (
              ...
              return (
                <Button 
                  ...
                  startIcon={
                    ...
                    </Icon>} color={selected ? "secondaryContainer" : "primary"}>
                    {sport}
                </Button>
              )
            })
    ...
    <Stack sx={{mb:4}}>
      ...
      <TextField label="Location" variant="outlined" fullWidth value={defaultValue.location} onChange={(event) => setLocation(event.target.value)} />
    </Stack>
            ...
            <Stack direction="column" spacing={1}>
              ...
              <Stack direction="row" spacing={2} >
                  <Button 
                    ...
                    size="large"          
                    disableElevation                          
                    variant={defaultValue.level === "Casual" ? "contained" : "outlined"}                      
                    color={defaultValue.level === "Casual" ? "secondaryContainer" : "primary"}
                  ...
                  <Button 
                    ...
                    size="large"          
                    disableElevation                          
                    variant={defaultValue.level === "Professional" ? "contained" : "outlined"}                      
                    color={defaultValue.level === "Professional" ? "secondaryContainer" : "primary"}
    ...
    <Stack>
      ...
      <TextField hiddenLabel fullWidth multiline rows={4} variant="filled" value={defaultValue.description} onChange={(event) => setDescription(event.target.value)} />
    </Stack>
  </Box>
  )
}